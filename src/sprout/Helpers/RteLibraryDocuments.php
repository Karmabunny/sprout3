...
/**
* Richtext library for media repository documents
**/
class RteLibraryDocuments extends RteLibrary
{
    ...
    public function browse($path)
    {
        ...
        if ($path == '') {
            ...
            $q = "SELECT cat.id, cat.name
                ...
                GROUP BY cat.id
                ORDER BY cat.name";
            $res = Pdb::query($q, [FileConstants::TYPE_DOCUMENT], 'pdo');
            ...
            $q = "SELECT files.name, files.filename, files.date_modified
                ...
                ORDER BY files.name";
            $res = Pdb::query($q, [$cat_id, FileConstants::TYPE_DOCUMENT], 'pdo');
    ...
    **/
    public function search($term)
    {
        ...
        $params = [FileConstants::TYPE_DOCUMENT];
