 ...
 *
 * @method static string tag(string $name, array $attrs = [], array $params = [])
 * @method static string input(string $name, string $name, array $params = [])
 * @method static string output(string $name, array $attrs = [])
 * @method static string text(string $name, array $attrs = [])
 * @method static string number(string $name, array $attrs = [])
 * @method static string money(string $name, array $attrs = [], array $options = [])
 * @method static string range(string $name, array $attrs = [])
 * @method static string dualRange($unused, array $attrs = [], array $options = [])
 * @method static string password(string $name, array $attrs = [])
 ...
 * @method static string multiline(string $name, array $unused = [])
 * @method static string dropdown($name, array $attrs = [], array $options = [])
 * @method static string dropdownItems(array $options, $selected = null)
 * @method static string autocomplete($name, array $attrs = [], array $options = [])
 * @method static string autocompleteList($name, array $attrs = [], array $options = [])
 * @method static string multiradio($name, array $attrs = [], array $options = [])
 * @method static string checkboxBoolList($name, array $attrs = [], array $settings = [])
 * @method static string checkboxSet($name, array $attrs = [], array $settings = [])
 * @method static string checkbox($name, $label, $value, $selected, array $attrs = [])
 * @method static string pageDropdown($name, array $attrs = [], array $options = [])
 * @method static string dropdownTree($name, array $attrs = [], array $options = [])
 * @method static string dropdownTreeItem($node, $depth, $selected, $exclude)
 * @method static string datepicker($name, array $attrs = [], array $options = [])
 * @method static string daterangepicker($name, array $attrs = [], array $options = [])
 * @method static string simpledaterangepicker($name, array $attrs = [], array $options = [])
 * @method static string datetimerangepicker($name, array $attrs = [], array $options = [])
 * @method static string timepicker($name, array $attrs = [], array $params = [])
 * @method static string datetimepicker($name, array $attrs = [], array $options = [])
 * @method static string totalselector($name, array $attrs = [], array $options = [])
 * @method static string colorpicker($name, array $attrs = [], array $params = [])
 * @method static string googleMap($name, array $attrs = [], array $params = [])
 * @method static string conditionsList($name, array $attrs = [], array $params = [])
 * @method static string autoCompleteAddress($name, array $attrs = [], array $options = [])
 * @method static string geocodeAddress($name, array $attrs = [], array $options = [])
 * @method static string randomCode($name, array $attrs = [], array $options = [])
 * @method static string multipleFileSelect($name, array $attrs = [], array $options = [])
 */
class Form
{
    static $errors;
