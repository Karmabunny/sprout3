    ...
    <div class="right-sidebar-inner">
        <div class="white-box">
            ...
            <div class="field-group-item">
                <a href="dbtools/exceptionLog?session_id=<?php echo Enc::html($log['session_id']) ?>">
                    Session
                </a>
            </div>
            <div class="field-group-item">
                <a href="dbtools/exceptionLog?ip_address=<?php echo Enc::html($log['ip_address']) ?>">
                    IP Address
                </a>
            </div>
            <div class="field-group-item">
                <a href="dbtools/exceptionLog?class=<?php echo Enc::html($log['class_name']) ?>&type=<?php echo $log['type'] ?>">
                    Class
                </a>
            </div>
            <br>
