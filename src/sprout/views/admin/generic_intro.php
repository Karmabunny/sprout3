...
<!-- Some records found - show the recent ones -->
    <form action="SITE/admin/contents/<?php echo strtolower($controller_name); ?>" method="get">
        <button type="submit" class="button button-small icon-after icon-insert_drive_file">Show all <?php echo strtolower($friendly_name); ?></button>
    </form>

    <br>

    <h3>Recently updated <?php echo strtolower($friendly_name); ?></h3>
