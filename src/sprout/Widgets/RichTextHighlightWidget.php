...
* Spits out HTML code
**/
class RichTextHighlightWidget extends Widget
{
    protected $friendly_name = "Highlight text block";
    ...
    {
        return '<div class="highlight">' . ContentReplace::html($this->settings['text']) . '<div class="clear"></div></div>';
    }
