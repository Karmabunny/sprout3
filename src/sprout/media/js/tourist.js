(function() {
  ...
  */
  ...
  Tourist.Tip.Base = (function() {
    ...
    Base.prototype.skipButtonTemplate = '<button class="button button-small button-green tour-next icon-after icon-keyboard_arrow_right">Skip this step</button>';

    Base.prototype.nextButtonTemplate = '<button class="button button-small button-green tour-next icon-after icon-keyboard_arrow_right">Next</button>';

    Base.prototype.finalButtonTemplate = '<button class="button button-small button-green tour-next">Okay, got it!</button>';

    Base.prototype.closeButtonTemplate = '<a class="button button-small button-red tour-close button-icon icon-before icon-close" href="#"></a>';

    Base.prototype.okButtonTemplate = '<button class="button button-small button-green tour-close">Okay</button>';
